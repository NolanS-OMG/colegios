...
const Review = ({ options, id }) => {
  return (
    <div key={options.id} id={id} className="w-80 h-full pt-4 pb-14">
      <article className="bg-slate-50 h-full shadow px-3 py-2 w-fit md:w-96 lg:w-fit m-0 md:m-auto lg:m-0">
...
const OfertaEducativa = () => {
  return (
    <section id="offert" className="mx-8 lg:mx-16 mt-20 custom-offset custom-offset-mobile">
      ...
      <TitleWithBorder
        text={`Oferta`}
        className={`lg:hidden block mx-auto w-fit text-6xl md:text-8xl text-center font-bold text-transparent tracking-wide roboto-slab`}
        id={`titleOferta`}
        offSet={80}
        mobile={true}
        hasOffset={true}
      ...
      <article className="w-full h-fit lg:px-16 my-16 flex flex-col lg:flex-row lg:justify-evenly lg:h-80">
        <NivelEducativoCard className={`my-4 lg:my-0 md:w-5/12 w-card md:mx-auto`}
      ...
      <article className="w-full aspect-square md:aspect-video lg:h-60">
